    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_bid', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listing', to='auctions.bid')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('posted_datetime', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 23, 23, 5, 214078))),
